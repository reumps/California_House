"""Exploration des Donnees — render function for tab."""
...
from components.shared import load_data, LABELS, PL, C
...
def render():
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    # FILTRES — inline dans la page
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    st.markdown('<div class="section-label">Filtres interactifs</div>', unsafe_allow_html=True)
    ...
    st.caption(f"**{len(df):,}** / {len(df_raw):,} districts affiches")
    st.markdown("---")
    ...
    with map_col2:
        ...
        map_n = st.slider("Points", 2000, min(len(df), 15000), min(6000, len(df)), 500, key="map_n")
    ...
    age_palette = ["#CBD5E0", "#7A8FA6", "#2C5282", "#1E3A5F", "#152A43"]
    fig_box = px.box(
        df_box,
        x="Tranche_age",
        y="MedHouseVal",
