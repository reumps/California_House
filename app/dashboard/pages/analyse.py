"""Analyse Approfondie — render function for tab."""
...
from components.shared import (
    load_data, load_test_predictions,
...
def render():
    ...
    pm1.metric("R2", f"{metrics['r2']:.4f}", help="Part de variance expliquee par le modele")
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    # VIZ 2 : Importance des variables
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    st.markdown(f"""
**Resultats principaux.** Le modele de regression lineaire atteint un R2 de {metrics['r2']:.4f},
